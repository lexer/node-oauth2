...
OAuth2.prototype.tokenRequest = function(params, headers, fn) {
  var self = this;
  ...
  var body = new Buffer(qs.stringify(params));
...
OAuth2.prototype.accessToken = function(code, headers, fn) {
  if ('function' == typeof headers) {
    fn = headers;
    headers = {};
  };
  ...
  this.tokenRequest(params, headers, fn);
}


OAuth2.prototype.refreshToken = function(refreshToken, headers, fn) {
  if ('function' == typeof headers) {
    fn = headers;
    headers = {};
  };
